...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_60_ansi(
        ...
        KC_LGUI, KC_A,    KC_S,    KC_D,    F_FKEYS, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    NAV_SCLN,KC_QUOT,           KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    KC_CAPS,
        KC_NO,   KC_LCTL, KC_LALT,                            KC_SPC,                             KC_RCTL, KC_RALT, KC_RCTL,  ADJ
    ),
    [_NAV] = LAYOUT_60_ansi(
    ...
    [_FKEYS] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, _______, _______, _______, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, _______,          _______,
