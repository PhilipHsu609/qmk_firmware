...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_60_ansi(
        ...
        FKEYS,   KC_LCTL, KC_LALT,                            KC_SPC,                             KC_RCTL, KC_RALT, FKEYS,    ADJ
    ),
    [_NAV] = LAYOUT_60_ansi(
    ...
    [_FKEYS] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, MS_BTN1, MS_UP,   MS_BTN2, _______, _______, _______, _______,
        _______, _______, _______, MS_BTN1, MS_BTN2, _______, MS_WHLD, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLU, _______,          _______,
