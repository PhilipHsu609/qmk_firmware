...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_60_ansi(
        ...
        FKEYS,   KC_LCTL, KC_LALT,                            KC_SPC,                             KC_RCTL, KC_RALT, KC_RCTL,  ADJ
    ),
    [_NAV] = LAYOUT_60_ansi(
    ...
    [_FKEYS] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, KC_BTN1, KC_BTN2, _______, KC_WH_U, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, _______,          _______,
    ...
    [_ADJUST] = LAYOUT_60_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          CAP_SRN,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   CAP_IMG,
